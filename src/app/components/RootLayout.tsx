      ...
      <footer className="border-t border-white/5 py-16 px-4 relative z-10 mt-32">
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
            ...
            <div>
              <h3 className="mb-4 text-sm uppercase tracking-wider text-white/40 font-semibold">Connect</h3>
              <div className="flex gap-3">
                <a href="https://www.linkedin.com/company/svara-techfusion/" target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full glass hover:glass-strong transition-all flex items-center justify-center hover-glow-blue group">
                ...
                <a href="https://x.com/SvaraTechfusion" target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full glass hover:glass-strong transition-all flex items-center justify-center hover-glow-blue group">
                  <svg className="w-5 h-5 text-white/60 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"></path></svg>
                </a>
                <a href="https://github.com/svaratechfusion-gif" target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full glass hover:glass-strong transition-all flex items-center justify-center hover-glow-blue group">
                ...
                <a href="https://www.instagram.com/svaratechfusion/" target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full glass hover:glass-strong transition-all flex items-center justify-center hover-glow-blue group">
